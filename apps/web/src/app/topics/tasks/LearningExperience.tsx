...
export default function LearningExperience({
  ...
  const [level, setStage] = useState<LearningStage>('flashcards');
        ...
        <div className="mb-8">
          <div className="flex justify-center space-x-4 mb-4">
            ...
            <button
              ...
              disabled={!completedStages.includes('social-media') && level !== 'social-media'}
            >
            ...
            <button
              ...
              disabled={!completedStages.includes('conversation') && level !== 'conversation'}
            >
        ...
        <div className="mb-4 p-4 bg-white rounded-lg shadow">
          <div className="flex justify-between items-center">
            ...
            <span className="text-sm text-gray-600">
              {completedStages.length}/3 levels completed
            </span>
          </div>
        </div>
